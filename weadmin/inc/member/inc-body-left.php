<div class="layout-sidemenu">
    <div class="brand">
        <a href="../core/index.php" class="link" title="">
            <div class="row no-gutters align-items-center">
                <div class="col-auto">
                    <figure class="cover">
                        <img class="img-cover" src="<?php  echo $core_pathname_crupload?>/<?php  echo $valPicSystem?>" />
                    </figure>
                </div>
                <div class="col">
                    <h2 class="title"><?php  echo $valNameSystem?></h2>
                    <p class="desc"><?php  echo $valTitleSystem?></p>
                </div>
            </div>
        </a>
    </div>

    <ul class="nav-list fluid" id="sidemenu">
        <li>
            <a href="../core/index.php" class="link <?php if ($menukeyid == 'dashboard') { ?>active<?php } ?>">
                <span class="icon">
                    <img src="../img/iconmenu/home.svg" />
                </span>
            ...
            while ($RowMenu = wewebFetchArrayDB($coreLanguageSQL, $Query)) {
                ...
                if ($permissionID != "NA" || $_SESSION[$valSiteManage . "core_session_level"] == "SuperAdmin") {
                    ...
                    if ($RowMenu[$core_tb_menu . "_moduletype"] == "Group") {
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="divLeftMenuTb">
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        <a  href="javascript:void(0)"   class="link <?php  if ($status_open == $myMenuID) { ?>fontContantB<?php  } else { ?><?php  } ?>">
                                            <span class="icon">
                                                <?php  if ($RowMenu[$core_tb_menu . "_icon"]) { ?><img src="<?php  echo  $RowMenu[$core_tb_menu . "_icon"] ?>" border="0" align="absmiddle" /><?php 
                                                } else {
                                                    echo " - ";
                        ...
                        <?php } else { ?> 
                            <li>
                                <a href="<?php echo $linkFileTo ?>" target="<?php echo $linkTaget ?>" class="link">
                                    <span class="icon">
                                        <?php  if ($RowMenu[$core_tb_menu . "_icon"]) { ?>
                                            <img src="<?php  echo  $RowMenu[$core_tb_menu . "_icon"] ?>" />
                                        <?php } else {
                                            echo " - ";
                                        }
                                        ?>  
        ...
        <!-- Hide Submenu -->
        <li>
            <a href="#submenu-1" class="link collapsed" data-toggle="collapse">
                <span class="icon">
                    <img src="../img/iconmenu/alert-circle.svg" />
                </span>
                Menu
            </a>
            <div class="collapse" id="submenu-1" data-parent="#sidemenu">
                <ul class="nav-list fluid">
                    <li>
                        <a href="#" class="link">Submenu</a>
                    </li>
                    <li>
                        <a href="#" class="link">Submenu</a>
                    </li>
        ...
        <!-- Active&Show Submenu -->
        <!-- <li>
            <a href="#submenu-2" class="link" data-toggle="collapse">
                <span class="icon"></span>
                Menu Show
            </a>
            <div class="collapse show" id="submenu-2" data-parent="#sidemenu">
                <ul class="nav-list fluid">
                    <li>
                        <a href="#" class="link">Submenu</a>
                    </li>
                    <li>
                        <a href="#" class="link active">Submenu</a>
                    </li>
                    <li>
                        <a href="#" class="link">Submenu</a>
                    </li>
         ...
         <li>
            <a href="../core/logs.php" class="link <?php if ($menukeyid == 'logs') { ?>active<?php } ?>">
                <span class="icon">
                    <img src="../img/iconmenu/file-text.svg" />
                </span>
                <?php echo $langTxt["nav:logs"] ?>
            </a>
        </li>

        <li>
            <a href="javascript:void(0)"onclick="checkLogoutUser();" class="link">
                <span class="icon">
                    <img src="../img/iconmenu/log-out.svg" />
                </span>
