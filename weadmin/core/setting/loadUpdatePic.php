	...
	if(!empty($_FILES['fileToUpload']['error'])){
		...
		if(!$ERROR) {
			...
			$Query=wewebQueryDB($coreLanguageSQL,$sql);
				...
				$msg .= "<div style=\"width:22px; height:22px;float:left;z-index:1; margin-left:-22px;cursor:pointer;\" onclick=\"delPicUpload('deletePic.php','boxPicNew')\"  title=\"Delete file\" ><img src=\"../img/btn/delete.png\" width=\"22\" height=\"22\"  border=\"0\"/></div>";
