...
<div class="layout-content">
	<div class="layout-content-topbar">
		<div class="row align-items-center">
			<div class="col">
				<h2 class="title typo-lg fw-medium"><?php  echo $langTxt["pr:editpermis"]?></h2>
			</div>
			<div class="col-auto">
				<div class="action">
	...
	<div class="card">
        ...
        <div class="card-body pb-1">
			...
			<div class="row mb-3">
                ...
                <div class="col">
                    <div class="block-control">
						<input name="inputnamegroup" id="inputnamegroup" type="text"  class="form-control" value="<?php  echo $valName?>"/>
                    </div>
                </div>
            </div>
		</div>
					...
					<tr class="sub">
						...
						<td>
							<label class="radio-control">
								...
								<div class="icon"></div>
								<div class="title"><span for="R<?php  echo $subtopic1[$Field."_id"]?>"><?php  echo $langTxt["pr:read"]?></span></div>
							</label>
						</td>
						<td>
							<label class="radio-control">
								...
								<div class="icon"></div>
								<div class="title"><span for="RW<?php  echo $subtopic[$Field."_id"]?>"><?php  echo $langTxt["pr:manage"]?></span></div>
							</label>
						</td>
						<td>
							<label class="radio-control">
								...
								<div class="icon"></div>
								<div class="title"><span for="NA<?php  echo $subtopic1[$Field."_id"]?>"><?php  echo $langTxt["pr:noaccess"]?></span></div>
							</label>
						</td>
					</tr>
					<?php 
