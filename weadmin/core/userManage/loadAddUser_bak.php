...
<div class="layout-content">
    ...
    <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?php echo $langTxt["us:crepermis"]?></span></td>
                  <td align="left">
  ...
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
        ...
        ?>
        <label>
          <div class="formDivRadioL"><input name="inputTypeUser" id="inputTypeUser" type="radio" class="formRadioContantTb" <?php  if($_REQUEST['inputUT']==$key || $key == 1){ ?> checked="checked" <?php  } ?> value="<?php echo $key?>" /></div>
  ...
  <tr class="typePrivate" <?php  if($_REQUEST['inputUT']== 2){ ?> style="display:none;" <?php  } ?> >
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder typePrivate"  <?php  if($_REQUEST['inputUT']== 2){ ?> style="display:none;" <?php  } ?> >
