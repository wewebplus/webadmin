...
$sql = "SELECT ".$mod_tb_root."_id,".$mod_tb_root."_action,".$mod_tb_root."_time  FROM ".$mod_tb_root;
$sql = $sql."  WHERE ".$mod_tb_root."_id >='0'  ORDER BY ".$mod_tb_root."_id DESC  LIMIT 0,5";
//print_pre($sql);
