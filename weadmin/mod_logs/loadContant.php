...
// Check to set default value #########################
                    ...
                    <form action="?" method="post" name="myForm" id="myForm">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
                                ...
                                <input style="margin-bottom: 10px;" name="sdateInput" type="text"  id="sdateInput"  placeholder="<?php echo $langMod["tit:sSedate"]?>" autocomplete="off" value="<?php echo trim($_REQUEST['sdateInputSe'])?>" class="formInputSearchStyle sdateInputSe" />
                                
												
								</td>
								<td class="selectSearch4" >
                                <input style="margin-bottom: 10px;" name="edateInput" type="text"  id="edateInput"  placeholder="<?php echo $langMod["tit:eSedate"]?>" autocomplete="off" value="<?php echo trim($_REQUEST['edateInputSe'])?>" class="formInputSearchStyle edateInputSe" />
